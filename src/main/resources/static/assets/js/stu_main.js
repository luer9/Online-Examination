...
(function ($) {
	...
	$('nav.main-navigation').meanmenu({
		meanMenuClose: '<img class="black" src="assets/img/icons/icon-close.png" alt="close icon"><img class="white" src="assets/img/icons/icon-close-white.png" alt="close icon">',
